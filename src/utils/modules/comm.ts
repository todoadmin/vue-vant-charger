...
/**
 * 字符串转为数组（通过一些符号分隔的字符串）
 * @param value any 内容
 * @param symbol string 符号
 * @return list 转换后的数组
 */
export const filterArr = (value:any,symbol:string = ',') => {
...
/**
 * 格式化GMT转普通格式时间（Fri Jul 01 2022 00:00:00 GMT+0800 (中国标准时间)   -->  2022-03-18 10:08:00）
 * @param time number
 * @param format string 格式 默认：yyyy-MM-dd h:m:s
 * @return string str
 */
//GMT转普通格式的方法
export const  GMTToStr = (time:string,format:string = '') => {
